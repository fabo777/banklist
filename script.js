...
const formatMovementDate = function (date, locale) {
  ...
  const dayaPassed = calcDaysPassed(new Date(), date);
  console.log(dayaPassed);

  if (dayaPassed === 0) return 'Today';
  if (dayaPassed === 1) return 'Yesterday';
  if (dayaPassed <= 7) return `${dayaPassed} days ago`;
